...
const Politic = ({ navigation,route }) => {
  ...
  const sendform1=()=>{
    ...
    console.log(id_User,cargopublico,nombrecargo,dependencia,fechaseparacion);
    axios
  ...
  const sendForm2=()=>{
    console.log(id_User,cargopublico2 ,parentesco,nombrefuncionario,apfuncionario,amfuncionario,ncargofuncionario,dependenciafunc,fechaseparacionf);
    axios.post(`${URI}/sendformpolitics2`,{
      id_User,
      cargopublico2,
      parentesco,
      nombrefuncionario,
  ...
  const sendform3=()=>{
    console.log(id_User,rsocial,tipopter,nombretercero,aptercero,amtercero,rfctercero,fechanactercero,curptercero,telfijo,teltrabajotercero,celulartercero)
    axios
